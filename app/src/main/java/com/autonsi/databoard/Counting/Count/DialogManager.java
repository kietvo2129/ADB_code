		...
		new AlertDialog.Builder(context).setTitle("Paired Bluetooth printers")
				.setItems(items, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						CountActivity.mBixolonLabelPrinter.connect(strDeviceInfo);
	...
	static void showUsbDialog(final Context context, final Set<UsbDevice> usbDevices, final BroadcastReceiver usbReceiver) {
		...
		new AlertDialog.Builder(context).setTitle("Connected USB printers")
				.setItems(items, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						CountActivity.mBixolonLabelPrinter.connect((UsbDevice) usbDevices.toArray()[which]);
	...
	static void showNetworkDialog(Context context, Set<String> ipAddressSet) {
		if (ipAddressSet != null) {
			...
			.setItems(items, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					CountActivity.mBixolonLabelPrinter.connect(items[which], 9100, 5000);
				}
			}).show();
		}
	}
			...
			dialog = new AlertDialog.Builder(context).setTitle(R.string.set_printing_type)
					.setSingleChoiceItems(ITEMS, 0, new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							CountActivity.mBixolonLabelPrinter.setPrintingType(type);
						}
...
//
//	static void showSetMarginValueDialog(AlertDialog dialog, Context context) {
//		if (dialog == null) {
//			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//							CountActivity.mBixolonLabelPrinter.setMargin(horizontalMargin, verticalMargin);
//						}
//					}).setNegativeButton("Cancel", new OnClickListener() {
//
//						public void onClick(DialogInterface dialog, int which) {
...
//	}
//
//	static void showSetLabelWidthDialog(AlertDialog dialog, Context context) {
//		if (dialog == null) {
//			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//								CountActivity.mBixolonLabelPrinter.setWidth(labelWidth);
//							}
//						}
//					}).setNegativeButton("Cancel", new OnClickListener() {
//
...
//	}
//
//	static void showSetLabelLengthAndGapDialog(AlertDialog dialog, Context context) {
//		if (dialog == null) {
//			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//								}
//
//								CountActivity.mBixolonLabelPrinter.setLength(labelLength, gapLength, mediaType, offsetLength);
//							}
//						}
//					}).setNegativeButton("Cancel", new OnClickListener() {
//
...
//
//							public void onClick(DialogInterface dialog, int which) {
//								CountActivity.mBixolonLabelPrinter.setBufferMode(mmCheckedItem == 1);
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
//							public void onClick(DialogInterface dialog, int which) {
...
//								case 0:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_25IPS);
//									break;
//								case 1:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_30IPS);
//									break;
//								case 2:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_40IPS);
//									break;
//								case 3:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_50IPS);
//									break;
//								case 4:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_60IPS);
//									break;
//								case 5:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_70IPS);
//									break;
//								case 6:
//									CountActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_80IPS);
//									break;
//								}
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
...
//								CountActivity.mBixolonLabelPrinter.setDensity(density);
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
//							public void onClick(DialogInterface dialog, int which) {
...
//								} else {
//									CountActivity.mBixolonLabelPrinter.setOrientation(BixolonLabelPrinter.ORIENTATION_BOTTOM_TO_TOP);
//								}
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
...
//	}
//
//	static void showSetOffsetBetweenBlackMarkDialog(AlertDialog dialog, Context context) {
//		if (dialog == null) {
//			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//								CountActivity.mBixolonLabelPrinter.setOffset(offset);
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
//							public void onClick(DialogInterface dialog, int which) {
...
//								CountActivity.mBixolonLabelPrinter.setCutterPosition(position);
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
//							public void onClick(DialogInterface dialog, int which) {
...
//								CountActivity.mBixolonLabelPrinter.setAutoCutter(radioGroup.getCheckedRadioButtonId() == R.id.radio0, cuttingPeriod);
//							}
//						}).setNegativeButton("Cancel", new OnClickListener() {
//
//							public void onClick(DialogInterface dialog, int which) {
