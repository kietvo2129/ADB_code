            ...
            public void onClick(View view) {
                ...
                if (userFullNameEditText.getText().toString() == null || userFullNameEditText.getText().toString().length() == 0) {
                   ...
                   // userLoginEditText.setError("Input PW");
                    ...
                    h1.setError(null);
                    h2.setError(null);
                    Log.d("Login",Url +"Home/Login?" + "user=" + userFullNameEditText.getText().toString() + "&password=" + userLoginEditText.getText().toString());
                    new docJSON().execute(Url + "Home/Login?" + "user=" + userFullNameEditText.getText().toString() + "&password=" + userLoginEditText.getText().toString());
                }
            }
        });
