package com.autonsi.databoard.AlarmData.StatusLayout;
...
public class MapBuildAlarmActivity extends AppCompatActivity {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonArray == null || jsonArray.length() == 0) {
                    AlerError.Baoloi("No data!", MapBuildAlarmActivity.this);
                    return;
                }
                ...
                e.printStackTrace();
                AlerError.Baoloi("Could not connect to server", MapBuildAlarmActivity.this);
            }
        }
        ...
        mapBuildAdapter.setOnItemClickListener(new MapBuildAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                    Intent intent = new Intent(MapBuildAlarmActivity.this, MapFloorAlrmActivity.class);
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(MapBuildAlarmActivity.this,
