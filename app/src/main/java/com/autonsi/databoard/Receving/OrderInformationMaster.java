...
public class OrderInformationMaster {
    ...
    String id,mt_cd,mt_cd_origin,mt_nm,mt_type,unit_cd,bundle_qty
    ...
    public OrderInformationMaster(String id, String mt_cd, String mt_cd_origin, String mt_nm, String mt_type, String unit_cd, String bundle_qty, String sp_cd, String qc_cd, String qc_range, String unit_price, String bundle_unit_price, String currency_code, String image, String re_mark, String use_yn, String reg_dt, String expiry_days, String sp_nm, String sp_type, String bundle_price, String storage_qty, String lct_cd, String status, String qty_bundle, String qc_name, String currency_name, String type_name, String unit_name, String status_name) {
        this.id = id;
        this.mt_cd = mt_cd;
        ...
        this.sp_cd = sp_cd;
        this.qc_cd = qc_cd;
        this.qc_range = qc_range;
        this.unit_price = unit_price;
        this.bundle_unit_price = bundle_unit_price;
    ...
    public String getQc_range() {
        return qc_range;
    }

    public void setQc_range(String qc_range) {
        this.qc_range = qc_range;
    }
    ...
    public String getBundle_unit_price() {
        return bundle_unit_price;
    }

    public void setBundle_unit_price(String bundle_unit_price) {
        this.bundle_unit_price = bundle_unit_price;
    }
    ...
    public String getQty_bundle() {
        return qty_bundle;
    }

    public void setQty_bundle(String qty_bundle) {
        this.qty_bundle = qty_bundle;
    }
